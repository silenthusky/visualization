<template>
  <div id="test">
    <el-row>
      <el-col :span="7">
        <div id="users_statistic" style="width:200px;height:200px;">
          <div id='test'>
            <div>
                {{ mdy }}
            </div>
    ...
    <el-row>
      <el-col :span="24">
          <div id="geo" style="width:1000px;height:1000px;"></div>
      </el-col>
    </el-row>
    </div>
</template>
 ...
 export default {
     ...
     watch: {
       ...
       users: function (newUsers) {
           this.users = newUsers;
           console.log("this.user" + newUsers);
    ...
    methods: {
        get_current_datetime() {
         ...
         drawChart(id) {
             ...
             this.request('statistics/users/ratio/buy');
         },
         drawgeo(id) {
